 ...
 * against another run. {@link #applyTo(LogRatioParameters)} is the only route from a recipe to a
...
public final class RegistrationRecipe {
    ...
    public static RegistrationRecipe of(LogRatioParameters parameters) {
     ...
     */
    public LogRatioParameters applyTo(LogRatioParameters base) {
