...
final class RelativeIntensityPatternSweepPlan {
    ...
    enum Parameter {
        ...
        RelativeIntensityPatternParameters apply(RelativeIntensityPatternParameters base, String value) {
            ...
            RelativeIntensityPatternParameters.Builder b = base.toBuilder().useRecommendation(false)
    ...
    static final class Combination {
        ...
        Combination(RelativeIntensityPatternParameters parameters, String label) {
        ...
        String macroOptions() {
            return new RelativeIntensityPatternDialogModel(parameters).toMacroOptions();
        }
    ...
    RelativeIntensityPatternSweepPlan(RelativeIntensityPatternParameters base, Axis... axes) {
    ...
    private static void build(RelativeIntensityPatternParameters current, List<Axis> axes, int index,
