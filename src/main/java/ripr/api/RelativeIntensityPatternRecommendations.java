...
public final class RelativeIntensityPatternRecommendations {
    private RelativeIntensityPatternRecommendations() { }

    public static RelativeIntensityPatternPreset forTypes(ImageType image, MotionType motion) {
        ...
        RelativeIntensityPatternPreset base;
        switch (image) {
            case PHASE_CONTRAST:
    ...
    private static RelativeIntensityPatternPreset huber(String evidence) {
        return preset("Huber weighting", evidence, RobustNorm.HUBER,
                PairAligner.PixelSupport.ALL, 0.5, Double.NaN, Double.NaN);
    }

    private static RelativeIntensityPatternPreset woods(String evidence) {
        return preset("Woods least squares", evidence, RobustNorm.LEAST_SQUARES,
                PairAligner.PixelSupport.ALL, 0.5, Double.NaN, Double.NaN);
    }

    private static RelativeIntensityPatternPreset tukeyGradient(String evidence) {
    ...
    private static RelativeIntensityPatternPreset mutual(String evidence) {
    ...
    private static RelativeIntensityPatternPreset ceiling10(String evidence) {
    ...
    private static RelativeIntensityPatternPreset ceiling25(String evidence) {
    ...
    private static RelativeIntensityPatternPreset floor25(String evidence) {
    ...
    private static RelativeIntensityPatternPreset preset(String name, String evidence, RobustNorm norm,
    ...
    private static RelativeIntensityPatternPreset preset(String name, String evidence, RobustNorm norm,
        ...
        return new RelativeIntensityPatternPreset(name, evidence, Preprocessing.NONE,
