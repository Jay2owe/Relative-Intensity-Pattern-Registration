...
public final class RelativeIntensityPatternPreset {
    ...
    RelativeIntensityPatternPreset(String name, String evidence, Preprocessing preprocessing,
    ...
    RelativeIntensityPatternPreset withPreprocessing(Preprocessing value) {
        if (value == Preprocessing.NONE) return this;
        return new RelativeIntensityPatternPreset(name + " + " + value.label(), evidence, value,
    ...
    RelativeIntensityPatternPreset withPixelSelection(PixelSelectionStrategy strategy,
                                      Preprocessing scoringFilter, double removePercent) {
        if (strategy == PixelSelectionStrategy.NONE) return this;
        return new RelativeIntensityPatternPreset(name + " + " + strategy.label(), evidence, preprocessing,
