 ...
 *
 * <pre>
 *   java -cp &lt;classes&gt;;&lt;test-classes&gt;;ij.jar logratio.BandProbe &lt;seed.tif&gt; [more seeds ...]
 * </pre>
 */
public final class BandProbe {
    ...
    private static final class PairAlignerDefaults {
        final double minValidFraction = new logratio.core.PairAligner.Options().minValidFraction;
    }
