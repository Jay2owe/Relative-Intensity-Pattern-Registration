...
public class LogRatioRecommendationsTest {
    @Test
    ...
    public void denseFluorescenceCurvedDriftExcludesDimmestQuarter() {
        LogRatioPreset preset = LogRatioRecommendations.forTypes(
    ...
    public void preprocessingIsRecommendedOnlyForTheFourValidatedCategories() {
        assertEquals(Preprocessing.GAUSSIAN_0_7, LogRatioRecommendations.forTypes(
                ImageType.PHASE_CONTRAST, MotionType.INTERMITTENT_JUMPS).preprocessing());
        assertEquals(Preprocessing.GAUSSIAN_1_0, LogRatioRecommendations.forTypes(
                ImageType.PHASE_CONTRAST, MotionType.SUBPIXEL_RANDOM_WALK).preprocessing());
        assertEquals(Preprocessing.MEDIAN_3X3, LogRatioRecommendations.forTypes(
        ...
        assertEquals(Preprocessing.NONE, LogRatioRecommendations.forTypes(
    ...
    public void sparseLowLightUsesValidatedSpatialMaskExceptForRandomWalk() {
        ...
        assertEquals(PixelSelectionStrategy.NONE, LogRatioRecommendations.forTypes(
