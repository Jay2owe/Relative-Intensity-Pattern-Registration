...
public interface PairEstimator {
    ...
    enum Kind implements PairEstimator {
         ...
         *
         * <p><b>What the automatic selector chooses for brightfield/DIC and fiducial/static — over a
         * failed sealed-set gate, by the project owner's explicit decision on 2026-08-20.</b> It
         ...
         * {@code docs/newton_refinement_plan.md}.
         *
