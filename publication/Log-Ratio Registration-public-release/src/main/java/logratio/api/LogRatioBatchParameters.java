...
public final class LogRatioBatchParameters {
    public final File inputDirectory;
    public final File outputDirectory;
    public final boolean recursive;
    public final boolean overwrite;
    public final LogRatioParameters registration;

    private LogRatioBatchParameters(Builder builder) {
    ...
    public static Builder builder(File inputDirectory, File outputDirectory,
                                  LogRatioParameters registration) {
    ...
    public static final class Builder {
        ...
        private final LogRatioParameters registration;
        ...
        public LogRatioBatchParameters build() { return new LogRatioBatchParameters(this); }
    }
}
