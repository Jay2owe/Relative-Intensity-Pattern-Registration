...
import logratio.core.Localisability;
 ...
 * {@code logratio.core}, the channel, the slice and any projection have already been decided — which is
...
public final class StackFrames implements FrameSource {
     ...
     * reason this is a separate call rather than something {@link logratio.core.Registration} does on
     * every run.
     */
