 ...
 * {@code +-log2(range/epsilon)} — order 10 in log2 units against a real gradient term of order
...
public enum RobustNorm {
    ...
    /**
     * Plain squared residual. The classical ratio image uniformity criterion — minimising the
     ...
     * Linear on average — a full sort of every residual on every iteration of every level of
